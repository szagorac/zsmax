...
public class OutgoingOscEventTranslator implements EventTranslatorOneArg<OscEvent, OscEvent> {
    static final Logger LOG = LoggerFactory.getLogger(OutgoingOscEventTranslator.class);
